...
export default function Message(msg, showUsername) {
  ...
  container.innerHTML = `
    ...
    <div style="display: flex; justify-content: ${isMe ? 'flex-end' : 'flex-start'}"> 
      ${
    !isMe ?
      `<img style="border-radius: 50%; background-color: #000;" src="${msg.photoURL ? msg.photoURL : './img/logo.png'}" width="50px" height="50px" />`
      : ''
    }
